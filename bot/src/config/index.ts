...
export const actionsMessages: Record<Exclude<SendActionType, 'BUY_LINK' | 'DEFAULT'>, ActionMessage> = {
  ...
  START_FUNNEL: {
    text: [
      '<blockquote><u>😱И всё это всего за 1.490₽😱</u></blockquote>\n\n',
      '<b>⚠️Важно⚠️</b>\n',
    ...
    buttons: [{ text: '💳 Оплатить 1.490₽', action: 'BUY_LINK', amount: 1490.0 }],
  },
  SUBSCRIBE: {
...
export const funnelMessages: FunnelMessage[] = [
  {
    ...
    buttons: [{ text: '💳 Получить доступ за 1.490₽', action: 'BUY_LINK', amount: 1490.0 }],
  },
  {
    id: 'reminder2',
  ...
  },
  {
    ...
    text: [
      ...
      '<b>СКИДКА -33%</b> на Гайд: Как я заработала миллион на фото своих ног🦶💸\n\n',
  ...
  },
  {
    ...
    delayMs: 1000 * 60 * 60 * 24, // 24 часа
    text: [
      'Лаааадно… Вы столько писали мне, что вам сейчас ну оооочень нужны лёгкие деньги, что я сдалась 🫣\n\n',
      '<b>Впервые я делаю скидку на Гайд -50% 🤯</b>\n\n',
      '<i>Всего за 750₽ вы сможете изменить свою жизнь! ',
